...
declare global {
  ...
  interface Array<T> {
    ...
    selectMany<TOut extends Array<any>>(selector: (element: T, index: number) => TOut): TOut;
...
Array.prototype.removeAt = function removeAt<T>(this: Array<T>, index: number): void {
  return List.prototype.removeAt.bind(this, index)();
};
...
// }
Array.prototype.selectMany = function selectMany<T, TOut extends Array<T>>(
  this: Array<T>,
