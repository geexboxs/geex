...
export declare class Typegoose {
    static getModel<T>(t: { new(...args: any[]): T }, { existingMongoose, schemaOptions, existingConnection }?: GetModelForClassOptions): mongoose.Model<InstanceType<T>, {}> & InstanceType<T> & T;
