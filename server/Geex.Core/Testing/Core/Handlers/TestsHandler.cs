...
namespace Geex.Core.Testing.Core.Handlers
{
    ...
    /// </summary>
    public class TestsHandler : IRequestHandler<GetTestsInput, IEnumerable<ITest>>, IRequestHandler<UpdateTestInput, ITest>
    {
        public DbContext DbContext { get; }

        public TestsHandler(DbContext dbContext)
        {
            DbContext = dbContext;
        }
